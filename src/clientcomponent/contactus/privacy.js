...
const CPrivacy = () => {
 ...
 residents must conspicuously post their privacy policy.[5]x (See also Online Privacy Protection Act)</p></p>
        </div>
         <div>
             <h1>Terms of User</h1>
...
ertise required to fully understand how computer systems and software products work.[11] Power users use advanced features of programs, though they are not necessarily capable of computer programming and system administration.[12][13]</p>
         </div>
        </footer>
    );
};
